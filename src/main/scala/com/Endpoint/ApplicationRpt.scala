...
//
//    val ret: DataFrame = ssc.sql("select ispname `运营商`," +
...
//      "from t_log)ret group by ispname   ")
//    ret.show()
//    ret.write.mode(SaveMode.Append)
//      .jdbc(getProperties()._2, "Business", getProperties()
//        ._1)
    ...
    val res: RDD[(String, Double, Double, Double, Double, Double, Double, Double, Double)] = ret.map(a => (a._1, a._2(0), a._2(1), a._2(2), a._2(5), a._2(6), a._2(3), a._2(4), a._2(7)))
